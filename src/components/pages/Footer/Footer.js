        ...
        <div className='footer-container'>
            ...
            <section className='social-media'>
                <div className='social-media-wrap'>
                    ...
                    <small className='website-rights'>LAVISH &copy; 2020</small>
                    <div className='social-icons'>
                        ...
                        <Link className='social-icon-link' to={'//www.youtube.com/channel/UCDmc3f7eL_YDarND2JGRuGA?view_as=subscriber'} target='_blank' aria-label='Youtube' >
                            <FaYoutube />
                        </Link>
